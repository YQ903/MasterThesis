function [h, X] = plotGMM(Mu, Sigma, color, valAlpha, linestyle, linewidth, edgeAlpha)
...
for i=1:nbStates
	...
	if nargin>3 %Plot with alpha transparency
		h = [h patch(X(1,:,i), X(2,:,i), color, 'lineWidth', 1, 'EdgeColor', darkcolor, 'facealpha', valAlpha,'edgealpha', edgeAlpha, 'linestyle', linestyle, 'linewidth', linewidth)];
