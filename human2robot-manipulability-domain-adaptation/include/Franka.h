...
public:
    ...
    const DQ_robotics::DQ_SerialManipulator& getKinematicsDQ() const;
...
private:
    // Hold a concrete manipulator (via pointer to base)
    std::unique_ptr<DQ_robotics::DQ_SerialManipulator> kinematics_;
};
