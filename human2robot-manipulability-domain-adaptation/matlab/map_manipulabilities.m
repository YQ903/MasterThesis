...
%     teacher_manipulabilities_random = csvread(base_path+"/"+robot_teacher+"/"+lookup_dataset+"/manipulabilities.csv");
    ...
    affine_trafos = csvread("/media/panda/data/yaqi/human2robot-manipulability-domain-adaptation/data/mapping/rhuman/10000/lookup_trafos_naive_rhuman_to_panda.csv");
