...
MatrixXd redManipulabilityJacobian3D(const MatrixXd &geomJ_, const Tensor<double, 3> &J_grad_){
    Tensor<double, 3> Jm = manipulabilityJacobian(geomJ_, J_grad_);
    MatrixXd Jm_red(6,6);
    Matrix<double,3,3> M_temp;
    Tensor<double, 3> J_result_m2t;
...
MatrixXd redManipulabilityJacobian6D(const MatrixXd &geomJ_, const Tensor<double, 3> &J_grad_){
    Tensor<double, 3> Jm = manipulabilityJacobian(geomJ_, J_grad_);
    MatrixXd Jm_red(21,6);
...
MatrixXd redManipulabilityJacobian6D7Joint(const MatrixXd &geomJ_, const Tensor<double, 3> &J_grad_){
    Tensor<double, 3> Jm = manipulabilityJacobian(geomJ_, J_grad_);
