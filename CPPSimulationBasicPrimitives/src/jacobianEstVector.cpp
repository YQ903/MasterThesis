    ...
    ) 
{
    ...
    Matrix<double, 3, 1> eigenvalue_i;
    Matrix<double, 3, 1> eigenvalue_ii;
    Matrix<double, 3, 6> JEV;
...
MatrixXd jacobianEstVector6D(const VectorXd& q, const int n,
    const DQ_SerialManipulator &robot
    ) 
{
    double q_delta = 0.00001;
...
MatrixXd jacobianEstVector6D7Joint(const VectorXd& q, const int n,
    const DQ_SerialManipulator &robot
    ) 
{
    double q_delta = 0.00001;
